<div class="tab-pane" id="commercial" style="color:#666666;">
    <div class="row">
        <div class="col-sm-1">
            <img src="{{asset('propuesta/img/icon/Comercial.png')}}" style="width: 75%;" alt="">
        </div>
        <div class="col-sm-10">
            ...
            <div id="div_cat_type_taxpayer" class="form-group label-floating">
                ...
                <select id="cat_type_taxpayer" name="cat_type_taxpayer" class="form-control">
                    ...
                    @foreach ($cat_type_taxpayer as $code => $description)
                        @if ($code == $datos[1]->id_tipo_contribuyente)
    ...
    <div class="row">
        <div class="col-sm-2 Code col-sm-offset-1 col-md-offset-3">
            <div id="div_code_agency" class="form-group label-floating">
                ...
                <input id="code_agency" name="code_agency" type="text" class="form-control" maxlength="10" value="{{$datos[0]->agency->codigo_oficina_virtual}}">
                <input type="hidden" id="agency" name="agency" value="true">
        ...
        <div class="col-sm-4">
            <div id="div_cat_method" class="form-group label-floating">
                ...
                <input id="cat_method" name="cat_method" type="text" class="form-control" value="{{$aliado->descripcion_tipo_aliado}}">
                <input type="hidden" id="vendor" name="vendor" value="{{$aliado->nombre}}">
            </div>
        </div>
    </div>
