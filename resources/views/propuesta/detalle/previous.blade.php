<div class="tab-pane" id="docPropuesta">
                ...
                <tr>
                    <td>
                        ...
                        <div class="row table-prop-2 plan plan_RG">
                            ...
                            <div class="col-sm-2">
                                <strong class="sinn" id="cantPlanRG">1</strong>
                            </div>
                            <div class="col-sm-2">
                        ...
                        <div class="row table-agency">
                            <div class="col-sm-12" style="margin-top: 10px;">
                                <p style="font-size: 1.5rem;"><b><strong class="sinn"
                                            ...
                                            id="clienteTipoExpediente"></strong></b></p>
                                ...
                                <p><b>Medio de adquisición: </b><strong class="sinn"
                                        style="text-transform: uppercase;" id="medioAdquisicion"></strong></p>
                    ...
                    <td>
                        <div class="row table-prices">
                            <div class="col-sm-12" style="padding: 20px;">
                                ...
                                <div class="right col-sm-4"><strong class="sinn" id="totalReteFuente"></strong>
                                </div>
                                <div class="left col-sm-8">
    ...
    <div class="row">
        <div class="col-sm-10 col-sm-offset-1 PropuestaCondiciones" style="font-size: 12px; text-align: justify;">
            ...
            <p>Las siguientes disposiciones rigen las condiciones para la prestación de los servicios de DOCUMENTOS
                ELECTRÓNICOS CON FINES FISCALES por parte de <b>THE FACTORY HKA COLOMBIA S.A.S</b> y <b>EL
                    SUSCRIPTOR</b>.</p>
            <br>
    ...
    <br>
    {{--
    Yo <strong class="repLegal" style="text-transform:uppercase"></strong>, identificado con <strong
                    class="typeDoc" style="text-transform:uppercase"></strong> N° <strong class="docRL"
                    style="text-transform:uppercase"></strong>, dirección de actividad comercial <strong class="direccion"
                    style="text-transform:uppercase"></strong>, domicilio de la actividad comercial en la ciudad <strong
                    class="municipio" style="text-transform:uppercase"></strong>, <strong class="departamento"
                    style="text-transform:uppercase"></strong>, telefono <strong class="telefono"
                    style="text-transform:uppercase"></strong>, correo electrónico <strong class="emailRepLegal"></strong>,
                actuando en nombre propio y/o en la representación legal de la sociedad <strong class="razonSocial"
                    style="text-transform:uppercase"></strong>, identificada con el NIT N° <strong class="numNit"
                    style="text-transform:uppercase"></strong> declaro expresa,
    --}}
    <div class="row">
        <div class="col-sm-10 col-sm-offset-1">
            <h6>
            ...
            <p style="font-size: 12px; text-align: justify;">
                ...
                persona y la sociedad que represento a diversas bases de datos, conforme a la ley 1266/2008. Certifico
                que los fondos de mi representada provienen de actividades lícitas y certifico la veracidad de los datos
                suministrados. Asumo la responsabilidad exclusiva de cualquier error, exonerando a THE FACTORY HKA
                COLOMBIA SAS de responsabilidad legal. La empresa garantiza seguridad y transparencia en el uso de la
                información, conforme a la ley 1581 del 2012. Entiendo que firmada la presente orden de compra, inicia
                el proceso de prestación del servicio por parte de THE FACTORY HKA COLOMBIA SAS, sin posibilidad de
                devolución. Acepto que no realizan traspasos de transacciones electrónicas entre diferentes NIT. Las
                transacciones compradas se mantienen en caso de cambio de razón social o representación legal, siempre
                que el NIT permanezca igual.
            </p>
        </div>
    </div>
    <br>
