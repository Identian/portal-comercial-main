    ...
    <div class="col-sm-10 col-sm-offset-1">
        <div class="input-group bg-terms" style="color:#666666;">
            @foreach ($terminos as $cod_termino => $nombre)
                <div class="togglebutton" id="div_termino_{{ $cod_termino }}" style="display: flex;align-items: flex-start; padding:15px 5px">
                    ...
                    <label style="color: #666666; display: flex; align-items: flex-start; width: 95%; margin-top: -5px;">
                        <input class="cat_termino" type="checkbox" value="{{ $cod_termino }}"
                            id="id_termino_{{ $cod_termino }}" name="listTermino[]">
