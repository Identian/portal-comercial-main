    ...
    <div class="set-full-height">
        ...
        <div class="container">
                            ...
                            <form id="cliente" method="post" enctype="multipart/form-data">
                                <div class="col-sm-12">
                                    ...
                                    <div class="pull-right">
                                        <img src="{{ asset('propuesta/img/icon/Icono-help.png') }}" class='btn-help'
                                            name='help' id="help" />
                                    </div>
                                </div>
                                {{ csrf_field() }}
                                ...
                                <div class="wizard-navigation">
                                    <ul id="lis-tab">
                                        <li><a class="tab tab_1" href="#start" data-toggle="tab">Inicio</a></li>
                                        <li><a class="tab tab_2" href="#enterprise" data-toggle="tab">Empresa</a></li>
                                        <li><a class="tab tab_3" href="#representative" data-toggle="tab">Datos</a></li>
                                        <li><a class="tab tab_4" href="#commercial" data-toggle="tab">Comercial</a></li>
                                        <li><a class="tab tab_5" href="#services" data-toggle="tab">Planes y
                                                Servicios</a></li>
                                ...
                                <div class="wizard-footer">
                                    <div class="pull-right">
                                        ...
                                        <input type='button' class='btn btn-info btn-fill btn-success btn-wd'
                                            name='next_order' id="next_order" value='Crear Nueva' />
                                        <input type='button' class='btn btn-info btn-fill btn-success btn-wd'
                                        ...
                                        <input type='button' class='btn btn-finish btn-fill btn-success btn-wd'
                                            id="finish" name='finish' value='Finalizar' />
                                        <input type='button' class='btn btn-finish btn-fill btn-success btn-wd'
                                ...
                                <div id="modal-conf" class="modal fade" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <button type="button" class="close" data-dismiss="modal"
                                                    aria-label="Close" id="modal-btn-close"><span
         ...
         <li>Paso 4. Cargue nuevamente el documento en nuestro Portal de Registro</li>
                                            ...
                                            <div class="wizard-footer">
                                                <div class="pull-right">
                                                    <button type="button" class="btn btn-fill btn-default btn-wd"
                                                        id="conf-btn-no">Cerrar</button>
                                                    <button type="button" class="btn btn-fill btn-success btn-wd"
                                                        id="conf-btn-si" style="margin-right: 10px;">Validar</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script src="{!! asset('propuesta/js/material-bootstrap-wizard.js') !!}?{{ substr(time(), -5) }}"></script>
