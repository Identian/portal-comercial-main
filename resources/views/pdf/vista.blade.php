...
<body>
    ...
    <main>
                ...
                <td colspan="2" width="60%" style="padding-left: 20px;">
                    <table width="80%" style="background-color: #E9E8E8;border-radius: 20px;padding: 10px;">
                        ...
                        @if ($tipoFoliosFacturacion != '')
                            <tr>
                                <td><b>Facturación:
                                    </b>{{ $tipoFoliosFacturacion == 1 ? 'Portal WEB' : 'Integración' }}
                                </td>
                            </tr>
                        @endif
                        @if ($tipoFoliosNomina != '')
                        ...
                        @if ($tipoFoliosRecepcion != '')
                            <tr>
                                <td><b>Recepcion: </b>{{ $tipoFoliosRecepcion == 1 ? 'Portal WEB' : 'Integración' }}
                                </td>
                            </tr>
                        @endif
                        <tr>
        ...
        {{--
        Yo
                                    <b>{{ mb_strtoupper($datos[3]->nombre . ' ' . $datos[3]->apellido, 'UTF-8') }}</b>,
                                    ...
                                    actuando en nombre propio y/o en la representación legal de la sociedad <b>
                                        ...
                                        @endif
                                    </b>, identificada con el NIT N° <b>{{ $datos[1]->company_id }}</b> declaro
                                    expresa,
        --}}
        ...
        <table width="100%" style="background-color: #E9E8E8;border-radius: 20px;padding: 10px;font-size:10px;">
                    ...
                    <table width="100%" style="text-align: center;border-collapse: collapse;">
                        <tr>
                            <td style="padding: 10px;width: 30%;">
                                <p style="border-top: 1px solid black;text-align: center; padding-top: 10px;">
                            ...
                            <td style="padding: 10px;width: 10%;">
                                <p
                                    style="width: 80px;height: 80px;border: 1px solid black;border-radius: 10px;text-align: center;line-height: 40px;">
                                </p>
                                <p>Huella Dactilar (Índice)</p>
                            </td>
                            <td style="padding: 10px;width: 30%;">
                                <p style="border-top: 1px solid black;text-align: center; padding-top: 10px;">
                                    Nro. Identificación
